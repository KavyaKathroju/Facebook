package loggingDemo.controller;
...
import loggingDemo.entity.Pojo;
import loggingDemo.exception.BusinessException;
import loggingDemo.service.ServiceLayer;
...
public class Controller {
	...
	public boolean findByclientid1(@PathVariable String clientid, @RequestBody Map<String, String> requestBody)
			throws Exception {
